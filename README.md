<p align="center">
  <img src="./assets/readme/hero.gif" width="100%" alt="TRAE K2：把 FoloToy 大赛工牌烧成闪电说 / PPT 蓝牙遥控器。">
</p>

一块大赛通行证，变成口袋里的 **闪电说 / PPT 遥控器**。

工牌自己就是一块 Windows 蓝牙键盘。不需要电脑伴侣脚本，不需要云，不需要 App。

<p align="center">
  <img src="./assets/readme/proof.png" width="100%" alt="同一块工牌，两个档位：Shandian 听写，PPT 翻页。">
</p>

<p align="center">
  <img src="./assets/readme/section-keys.svg" width="100%" alt="01 三键，两档。确认键是换挡，不是确定。">
</p>

<p align="center">
  <img src="./assets/readme/keymap.svg" width="100%" alt="Shandian：上键右 Ctrl、下键 Enter。PPT：上键 PageUp、下键 PageDown。确认短按换挡，长按回菜单。">
</p>
...
这是 FoloToy **TRAE AI Passport**（ESP32-C3 + 彩屏 + 三键）的社区固件。出厂是门票名片；这里把它换成 BLE HID 键盘。闪电说吃的是真正的 HID 右 Ctrl，不是脚本模拟按键。

<p align="center">
  <img src="./assets/readme/section-flash.svg" width="100%" alt="02 先备份出厂 Flash，再烧预编译固件。">
</p>
...
脚本按 USB **VID `303A` PID `1001`** 自动找口，写入：
...
<p align="center">
  <img src="./assets/readme/section-pair.svg" width="100%" alt="03 蓝牙名 TRAE K2。配对一次，关机再开自己连。">
</p>
...
为什么这样设计、哪些路走过是错的：[CONTEXT.md](CONTEXT.md)
